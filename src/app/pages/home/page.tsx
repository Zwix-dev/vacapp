        ...
        <>
            ...
            <section className="py-10 bg-gray-50 dark:bg-inherit dark:border-gray-800" id="features">
                <div className="container mx-auto text-center px-4">
                    ...
                    <p className="mt-4 text-gray-500 text-lg m-10 dark:text-gray-300">
                        ...
                        <div className="border-gray-100 border p-10 rounded-lg hover:shadow-xl dark:hover:shadow-lg bg-white hover:shadow-gray-200/50 dark:hover:shadow-yellow-500/50 dark:bg-gray-800 dark:border-gray-700">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10">
                                    <p className="text-xl font-sans text-indigo-900 m-8 font-semibold dark:text-white">Interfaces</p>
                                    <p className="text-gray-500 dark:text-gray-300">Conçu pour offrir une expérience visuelle épurée et élégante. Avec une interface intuitive et un design minimaliste, il met en valeur l'essentiel pour garantir une navigation fluide et agréable.</p>
                                </div>
                            </div>
                        </div>
                        <div className="border-gray-100 border p-10 rounded-lg hover:shadow-xl dark:hover:shadow-lg bg-white hover:shadow-gray-200/50 dark:hover:shadow-yellow-500/50 dark:bg-gray-800 dark:border-gray-700 ">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10">
                                    <p className="text-xl text-indigo-900 m-8 font-semibold dark:text-white">Clean code</p>
                                    <p className="text-gray-500 dark:text-gray-300">Notre outil garantit un code lisible, bien structuré et facilement maintenable. Chaque fonctionnalité est implémentée de manière claire, concise et modulaire, facilitant les évolutions et assurant une performance optimale.</p>
                                </div>
                            </div>
                        </div>
                        <div className="border-gray-100 border p-10 rounded-lg hover:shadow-xl dark:hover:shadow-lg bg-white hover:shadow-gray-200/50 dark:hover:shadow-yellow-500/50 dark:bg-gray-800 dark:border-gray-700">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10">
                                    <p className="text-xl text-indigo-900 m-8 font-semibold dark:text-white">Securisé</p>
                                    <p className="text-gray-500 dark:text-gray-300">Nous garantissons la sécurité de vos données en utilisant des protocoles de chiffrement SSL pour assurer la confidentialité des informations échangées. Des mises à jour fréquentes sont également réalisées pour maintenir la sécurité.</p>
                                </div>
                            </div>
                        </div>
                    </div>
