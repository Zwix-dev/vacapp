                    ...
                    <div className="flex flex-col p-4 md:flex-row gap-8 justify-center ">
                        <div className="border-gray-200 border p-10 rounded-lg hover:shadow-xl hover:shadow-gray-200/50">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10">
                                    <p className="text-xl font-sans text-slate-500 m-8 font-semibold">Interfaces</p>
                        ...
                        <div className="border-gray-200 border p-10 rounded-lg hover:shadow-xl hover:shadow-gray-200/50">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10"> 
                                    <p className="text-xl text-slate-500 m-8 font-semibold">Clean code</p>
                        ...
                        <div className="border-gray-200 border p-10 rounded-lg hover:shadow-xl hover:shadow-gray-200/50">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-col w-80 pb-10"> 
                                    <p className="text-xl text-slate-500 m-8 font-semibold">Securisé</p>
